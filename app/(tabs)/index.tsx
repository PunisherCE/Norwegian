...
function getWords(subject: subjectType): wordsTo {
  switch (subject) {
    ...
    case "book1":
      currentIndex = Math.floor(Math.random() * book1.length)
      if (testeIndex !== currentIndex) {
        testeIndex = currentIndex
      } else return getWords(subject)
...
"ja da", "oh yes",
"forresten", "by the way; besides",
"jeg har det travelt", "I'm in a hurry",
"myndighetene", "authorities",
"varemagasinet", "department store",
"haken", "chin",
"meget", "very",
"når det gjelder", "as far as is concerned",
"tremenningen", "second cousin",
"sammentreffet", "coincidence",
...
"utmerket", "excellent",
"skiven", "slice",
"spekepølsen", "cured sausage",
"å klare seg", "be enough",
"anliggende", "concern",
"ekspeditøren", "shop assistant",
"temmelig", "fairly",
"javel", "certainly",
"å tenne", "to light",
"bøye", "bend; submit",
...
"bestemmelsesstedet", "the destination",
...
"enhver", "each; every",
"et snes", "a score",
"utlendingen", "foreigner",
"å mestre", "to master",
"anstrengelsen", "effort",
"anledningen", "opportunity",
"fullføre", "go through with",
"etterpå", "afterwards",
"moro", "fun",
"strekke", "stretch",
"forlove seg", "get engaged",
"å slanke", "to slim",
"overflødig", "superfluous; excess",
"hva som enn", "whatever",
"ståket", "the noise",
"bankrøveriet", "bank robbery",
"å slutte seg til", "to join",
"likså", "as; like",
"gjerdet", "fence",
"mistanken", "suspicion",
"enten", "either",
"verken", "neither",
"nokså", "fairly",
"å gi utsikt over", "to overlook",
"å vende mot", "to face",
"opplysningene", "information",
...
"ettersom", "as",
"drosjen", "taxi",
"vi ville nødig", "we'd rather not",
"å gå glipp av", "to miss",
"umaken verdt", "worthwhile",
"forstår du", "you see",
"faktoren", "factor",
"håndtert", "handled",
...
"rimelig", "reasonable",
"atskilling", "a lot",
"lokalkart", "map of the area",
"betingelsene", "the terms",
"tilbudet", "proposal",
"lodd", "prize",
"fjern", "far off",
"uoppdaget", "unexplored",
"være i stand til", "to be able to",
"å ta motet fra", "to discourage",
"uutforskede", "unexplored",
"å lykkes", "to succeed",
"formannen", "chairman",
"å overrekke", "to hand out",
"lønnforhøyelsen", "wage increase",
"hårsbredd", "hair's breadth",
"susende", "dashing",
"sjøen", "the sea",
"å fange", "to catch",
"tåpelig", "silly",
"vettskremt", "terrified",
"rattet", "the wheel",
"forbannet på", "mad at",
"fotgjengeren", "pedestrian",
"å skjelle", "to curse; scold",
"å pågå", "to go on",
"sperret", "barred",
"å bryte sammen", "to come to a stand still",
"å skulle til å", "to be about to",
"oppgi", "give up",
"myldrer", "swarming",
"kelneren", "waiter",
"å behage", "to please",
"stri med", "work hard at",
"rosen", "praise",
"etterkommeren", "descendant",
"hemningsløst", "without inhibition",
"seieren", "the victory",
"umåtelig", "immensely",
"nederlaget", "the defeat",
"dommeren", "referee",
"i så henseende", "in that respect",
"dressert", "trained",
"virkning", "effect",
...
"morn", "hello",
"morn da", "bye",
"ærbødigst", "yours faithfully; sincerely",
"oppholdet", "to stay",
"å berolige", "to calm down",
"spent", "curious",
"havnen", "port",
"å innse", "to realise",
